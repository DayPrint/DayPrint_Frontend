      ...
      <div className="content">
        ...
        <form autoComplete="off" onSubmit={register} class="sign_up_form">
          ...
          <div className="field">
            ...
            <input type="text" id="userName" name="username" onChange={onChange} placeholder="  사용자이름" required/>
          </div>
          <div className="field">
            <label for="phone" class="hidden">PhoneNumber</label>
            <i className="fas fa-phone" />
            <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{4}-[0-9]{4}" onChange={onChange} placeholder="  연락처 (000-0000-0000)" required />
          </div>
          <div className="field">
            <label for="userEmail" class="hidden">email</label>
            <i className="far fa-envelope" />
            <input type="email" id="userEmail" name="id" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" onChange={onChange} placeholder="  아이디(E-mail)" required />
          </div>
          <div className="field">
          ...
          <div className="field">
            <label for="userPass" class="hidden">password</label>
            <i className="fas fa-lock" />
            <input type="password" id="passConfirm" name="passwd2" onChange={checkPasswd} placeholder="  비밀번호 확인" required />
